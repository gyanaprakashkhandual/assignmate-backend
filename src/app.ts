...
import aiResponseRouter from "./routes/ai/message.route";
import handwritingRouter from "./routes/handwriting/handwriting.route"
...
app.use("/api/messages", aiResponseRouter);
